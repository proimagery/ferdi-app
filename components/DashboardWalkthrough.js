...
export default function DashboardWalkthrough({ visible, onComplete }) {
  ...
  const steps = [
    ...
    },
    {
      icon: 'apps',
      iconColor: '#a78bfa',
      title: t('walkthrough.navBarTitle'),
      description: t('walkthrough.navBarDesc'),
    },
    {
      icon: 'add-circle',
      iconColor: theme.primary,
      title: t('walkthrough.createTripTitle'),
      description: t('walkthrough.createTripDesc'),
    },
    {
      icon: 'stats-chart',
      iconColor: '#fb923c',
      title: t('walkthrough.statsTitle'),
      description: t('walkthrough.statsDesc'),
    },
    {
      icon: 'globe',
      iconColor: '#34d399',
      title: t('walkthrough.worldInfoTitle'),
      description: t('walkthrough.worldInfoDesc'),
    },
    {
      icon: 'person-circle',
      iconColor: '#06b6d4',
