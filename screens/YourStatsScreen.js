...
import { subregionMap, allSubregions, getVisitedSubregions } from '../utils/subregionMap';
...
export default function YourStatsScreen({ navigation }) {
  ...
  // Calculate visited subregions (needed for stats grid and subregions section)
  ...
  const stats = [
    ...
    {
      icon: 'layers',
      label: 'Subregions Visited',
      value: visitedSubregions.length,
      color: '#fb923c',
      clickable: false,
    },
    {
